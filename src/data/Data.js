export const data = [
    {
      ...
      category: 'burger',
      desc : " a hamburger with a slice of melted cheese on top of the meat patty, added near the end of the cooking time.",
      image:
    ...
    },
    {
      ...
      category: 'burger',
      desc : " The patty itself is often seasoned or augmented with chopped onions, spices, or bread crumbs before cooking",
      image:
    ...
    },
    {
      ...
      category: 'burger',
      desc : "Finely diced mushrooms are added into Ground Beef patties and grilled to juicy perfection",
      image:
    ...
    },
    {
      ...
      name: 'Feta & Spinnach',
      category: 'pizza',
      desc: "fresh, white, soft or semisoft cheese of Greece, originally made exclusively from goat's or sheep's milk but in modern times containing cow's milk",
      image:
    ...
    },
    {
      ...
      name: 'Supreme Pizza',
      category: 'pizza',
      desc: "Everything in a good bite of pizza should be balanced. The sauce shouldn't overpower the cheese and vice versa, the crust-to-sauce ratio should be even, and the choice of toppings should work fine together",
      image:
    ...
    },
    {
      ...
      name: 'Meat Lovers',
      category: 'pizza',
      desc: "A pizza boy unknowingly goes a house off from his delivery and finds himself captured to be used as a sacrifice for a basement cult's God.",
      image:
    ...
    },
    {
      ...
      name: 'Cheese Pizza',
      category: 'pizza',
      desc: "The tasty reward is a crispy-bottomed, airy crust topped with tangy tomato sauce, and milky mozzarella",
      image:
    ...
    },
    {
      ...
      name: 'Kale Salad',
      category: 'salad',
      desc: " fresh, hearty kale, salty Parmesan cheese, toasted almonds, sweet dried cranberries, and a fresh lemon balsamic dressing.",
      image:
    ...
    },
    {
      ...
      name: 'Ceasar Salad',
      category: 'salad',
      desc: "a green salad of romaine with a highly seasoned dressing of pounded anchovies, olive oil, lemon juice, egg, and Parmesan cheese, garnished with croutons",
      image:
    ...
    },
    {
      ...
      name: 'Loaded Salad',
      category: 'salad',
      desc: "any of the various “usually cold dishes” including raw greens, vegetables and toppings",
      image:
    ...
    },
    {
      ...
      name: 'Fruit Salad',
      category: 'salad',
      desc: "a dish consisting of various kinds of fruit, sometimes served in a liquid, either their juices or a syrup.",
      image:
    ...
    },
    {
      ...
      name: 'Wings',
      category: 'chicken',
      desc: "either of the two forelimbs of most birds and of bats, corresponding to the human arms, that are specialized for flight.",
      image:
    ...
    },
    {
      ...
      name: 'Baked Chicken',
      category: 'chicken',
      desc: "the chicken is often cooked in a pot with a closed lid, in a sauce, or as one ingredient in a mixture",
      image:
    ...
    },
    {
      ...
      category: 'chicken',
      desc: "chicken meat dipped in breading and then deep-fried, grilled or baked",
      image:
